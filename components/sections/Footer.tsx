...
const socials = [
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/stndout_marketing/',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-b border-white/[0.06]">
          <div className="max-w-[1600px] mx-auto px-6 md:px-12 py-10 md:py-14 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="footer-reveal">
              <Link
                href="/contact"
                className="group inline-flex items-center gap-3 px-10 py-5 bg-brand-primary text-white font-bold text-lg rounded-full hover:bg-brand-cream hover:text-brand-dark transition-all duration-300"
              >
                Let&apos;s Talk
